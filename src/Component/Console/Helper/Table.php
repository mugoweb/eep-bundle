...
namespace MugoWeb\Eep\Bundle\Component\Console\Helper;
...
class Table
{
     ...
     * (Note: header row separator modified to allows easy parsing of 'data' rows
     *
     * Example:
     *
     *     +---------------+-----------------------+------------------+
     *     I ISBN          I Title                 I Author           I
     *     +---------------+-----------------------+------------------+
    ...
    public function render()
    {
        ...
        foreach ($rowGroups as $rowGroup) {
            ...
            foreach ($rowGroup as $row) {
                ...
                // hack header row vertical separator style
                $this->style->setVerticalBorderChars($isHeader? 'I' : '|');
