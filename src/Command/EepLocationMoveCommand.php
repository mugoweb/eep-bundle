...
class EepLocationMoveCommand extends Command
{
...
EOD;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        {
            throw new BaseInvalidArgumentException('target-location-id', 'Target location is a sub location of the source subtree');
        }
        ...
        {
            throw new BaseInvalidArgumentException('target-location-id', 'Cannot move location to a parent that is not a container');
        }
