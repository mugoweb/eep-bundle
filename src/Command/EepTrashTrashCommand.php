...
class EepTrashTrashCommand extends Command
{
...
EOD;
        ...
        $this
            ->setName('eep:trash:trash')
            ->setAliases(array('eep:tr:trash'))
            ->setDescription('Trashes a location subtree')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!$confirm)
        {
            $confirm = $io->confirm(
                sprintf(
                    'Are you sure you want to trash "%s" subtree (%d children)? This may take a while for subtrees with a large number of nested children',
        ...
        {
            $io->writeln('Trashing cancelled by user action');
        }
