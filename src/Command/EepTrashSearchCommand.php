...
EOD;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        (
            'ContentTypeId' => 'eZ\Publish\API\Repository\Values\Content\Query\Criterion\ContentTypeId',
            'DateMetadata' => 'eZ\Publish\API\Repository\Values\Content\Query\Criterion\DateMetadata',
            'SectionId' => 'eZ\Publish\API\Repository\Values\Content\Query\Criterion\SectionId',
            'UserMetadata' => 'eZ\Publish\API\Repository\Values\Content\Query\Criterion\UserMetadata',
        );
        $sortClausesMap = array
        (
            'ContentName' => 'eZ\Publish\API\Repository\Values\Content\Query\SortClause\ContentName',
            'ContentTypeName' => 'eZ\Publish\API\Repository\Values\Content\Query\SortClause\Trash\ContentTypeName',
            'DateTrashed' => 'eZ\Publish\API\Repository\Values\Content\Query\SortClause\Trash\DateTrashed',
            'Depth' => 'eZ\Publish\API\Repository\Values\Content\Query\SortClause\Location\Depth',
            ...
            'UserLogin' => 'eZ\Publish\API\Repository\Values\Content\Query\SortClause\Trash\UserLogin',
        );
