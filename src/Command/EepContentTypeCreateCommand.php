...
-------------------------
{
    ...
    "fields": [
        ...
        {
            "identifier": "rating",
            "fieldTypeIdentifier": "ibexa_float",
            "names": {
                "eng-GB": "Rating"
            },
            "descriptions": {
        ...
        {
            "identifier": "quantity",
            "fieldTypeIdentifier": "ibexa_integer",
            "names": {
                "eng-GB": "Quantity"
            },
            "descriptions": {
        ...
        },
        {
            ...
            "fieldTypeIdentifier": "ibexa_binaryfile",
            "names": {
                "eng-GB": "Attachment"
            },
            "descriptions": {
        ...
        },
        {
            ...
            "fieldTypeIdentifier": "ibexa_datetime",
            "names": {
                "eng-GB": "Published at"
            },
            "descriptions": {
        ...
        },
        {
            ...
            "fieldTypeIdentifier": "ibexa_date",
            "names": {
                "eng-GB": "Event date"
            },
            "descriptions": {
        ...
        },
        {
            ...
            "fieldTypeIdentifier": "ibexa_time",
            "names": {
                "eng-GB": "Opening time"
            },
            "descriptions": {
...
from Ibexa\Contracts\Core\Repository\Values\Content\Location::SORT_FIELD_* / SORT_ORDER_*.
...
Only one ibexa_user field is allowed per content type.

For all other types check the field type's \$settingsSchema/\$validatorConfigurationSchema in vendor/ibexa/core/src/lib/FieldType before using it.
